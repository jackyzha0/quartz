...
export const GalleryTransformer: QuartzTransformerPlugin<Partial<Options> | undefined> = (userOpts) => {
                ...
                return (tree: Root, _file) => {
                    ...
                    visit(tree, "code", (node: Code, index) => {
                        ...
                        if (node && node.lang === opts.language && index != null) {
                            ...
                            const data = yaml.load(node.value, { schema: yaml.JSON_SCHEMA }) as ImgGalleryParsedData
                    ...
                    galleryData.sort((a, b) => b.blockIndex - a.blockIndex).forEach(gallery => {
