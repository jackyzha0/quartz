...
The multiple-choice results were worse. When I shuffled answer options, MedGemma changed its answer 59.1% of the time. Simple rotations dropped accuracy by as much as 27.4 points. That means the model was often reacting to position, not content. A system that changes its medical answer because the choices were rearranged is not reasoning in any meaningful sense that should comfort us. It is pattern matching with a lab coat on.
