...
[[Projects/eduweb]] to projekt w który angażuję się od kwietnia 2020 roku. Ma on dla mnie szczególne znaczenie, ponieważ to właśnie na eduweb zaczynałem poważną naukę programowania.
...
Materiał stanowiący absolutne wprowadzenie do [[TypeScript]] wyjaśniający fundamentalne założenia oraz składnię. Przeznaczony jest dla osób, które znają już [[Knowledge/Programming/JavaScript/JavaScript]].

🔗 [Strona kursu](https://eduweb.pl/programowanie-i-www/typescript/typescript-podstawy?ref=overment)

### Kurs TypeScript - Zaawansowany
Jest to kontyunacja kursu [[Projects/eduweb#Kurs TypeScript - Podstawy]] w której przechodzę przez bardziej zaawansowane wykorzystanie typów oraz praktyczną konfigurację projektu TypeScript. 
...
Warsztat na temat typów w [[Knowledge/Programming/JavaScript/JavaScript]] oraz ich znaczenia w kontekście [[TypeScript]]. Dowiesz się z niego czym jest statyczne i dynamiczne typowanie. Pokazuję w nim również jakie argumenty przemawiają za wykorzystaniem TypeScript.
...
Ten warsztat przeznaczony jest dla osób, które chcą zobaczyć jak korzystać z [[Tailwind CSS]] w praktyce na przykładzie kodowania komponentu serwisu [[Projects/eduweb]]. Dodatkowo zachęcam do przeczytania mojego [wpisu na temat Tailwind](https://blog.eduweb.pl/tailwind-to-rewolucja-jesli/)
...
W tym materiale znajdziesz minimum niezbędnej wiedzy na temat [[Regex]], która z pewnością przyda Ci się w codziennej pracy. Poza tym są to umiejętności przydatne w korzystaniu z aplikacji takich jak [[Optimization/Tools/MakeHQ]], [[Optimization/Tools/Zapier]], [[Optimization/Tools/Keyboard Maestro]] lub [[Optimization/Tools/Hazel]].
...
W tym materiale dzielę się swoimi sugestiami w kontekście [[Optimization/Optimization]] pracy programisty. Wskazuję w nim 
...
- w jaki sposób AI pomaga nam kodować już dziś? ([[Optimization/Tools/Tabnine]])
...
Warsztat w którym pokazuję czym jest [[Svelte]], jakie możliwości oferuje w porównaniu z innymi frameworkami [[Knowledge/Programming/JavaScript/JavaScript]] oraz czy warto z niego korzystać?
...
CSS Houdini to stosunkowo nowe API [[CSS]], dające większe możliwości kontroli właściwości CSS, definiowania własnych oraz tworzenia wydajnych i zaawansowanych animacji w połączeniu z [[Knowledge/Programming/JavaScript/JavaScript]].
...
Osobiście wykorzystuję [[Laravel]] w kilku rozwijanych przeze mnie projektach. Livewire to framework [[Knowledge/Programming/JavaScript/JavaScript]] umożliwiający tworzenie wysoko interaktywnych aplikacji bez konieczności wykorzystania framework'ów front-endowych. 
...
Nagranie z nowymi funkcjami [[Knowledge/Programming/JavaScript/JavaScript]] dostępnymi wraz z [[ES2019]] i [[ES2020]] a w tym: 
...
W tym warsztacie wyjaśniam najważniejsze koncepcje dotyczące asynchroniczności w [[Knowledge/Programming/JavaScript/JavaScript]] takie jak [[Event Loop]], [[Knowledge/Programming/JavaScript/Programowanie funkcyjne/Higher-Order Function]], [[Knowledge/Programming/JavaScript/Programowanie funkcyjne/Currying]], [[Knowledge/Programming/JavaScript/Programowanie funkcyjne/Pure Functions]], [[Callback]], [[Knowledge/Programming/JavaScript/Promise/Promise]], [[Knowledge/Programming/JavaScript/Promise/Async Await]] oraz obsługę błędów w JavaScript. 
...
Ten warsztat zawiera najważniejsze techniki dotyczące debugowania kodu [[Knowledge/Programming/JavaScript/JavaScript]] zarówno z wykorzystaniem Chrome Dev Tools jak i wbudowanego debuggera w [[Visual Studio Code]]. Całość uwzględnia zarówno debugowanie aplikacji po stronie klienta ([[Vue]]) oraz serwera ([[Nest]])
...
Warsztat w którym wyjaśniam kluczowe koncepcje [[Knowledge/Programming/JavaScript/JavaScript]], które często sprawiają wiele problemów. Mowa o: 
- Zakres globalny, lokalny i blokowy [[Knowledge/Programming/JavaScript/Zakres/Scope]]
