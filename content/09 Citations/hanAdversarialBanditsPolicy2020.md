...
project: NA
priority: p5
created: 2023-09-12 13:13
modified: 2024-09-13 11:45
---
...
# Top Notes
- Read this and pulled a few more papers to read from this
- Not much I can do with this as it relies on certain variables that I don’t know how I would translate
	- Such as
	- “offers”
	- “click rate”
	- “impression”
	- “offer crawling budget”
	- “local price”
- This works as a k-arm bandit problem where each arm is one of 5 algorithms which generate a periodicity according to a pre-existing algo
- They then choose one to use based on the probability of that arm
- But it ended up mostly choosing the LambdaCrawl algorithm anyway
-
