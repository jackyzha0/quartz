...
1. In your local Quartz, create a new file `quartz/.github/workflows/deploy.yml`.
...
2. Commit these changes by doing `npx quartz sync`. 
3. Head to "Settings" tab of your forked repository and in the sidebar, click "Pages".
4. Under "Source", select "GitHub Actions". This should deploy your site to `<github-username>.github.io/<repository-name>`.
