...
export interface AccessNFTInterface extends utils.Interface {
  functions: {
    ...
    "accessNftIsTransferable()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "accessNftIsTransferable",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "lastTimeToRedeem",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setLastTimeToRedeem",
    values: [BigNumberish, BigNumberish]
  ): string;
  ...
  events: {
    "AccessNFTRedeemed(address,uint256,uint256,uint256)": EventFragment;
    "AccessNFTsCreated(address,uint256[],string[],uint256[],string[],uint256[])": EventFragment;
    "AccessTransferabilityUpdated(bool)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "AccessNFTRedeemed"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "AccessNFTsCreated"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "AccessTransferabilityUpdated"
  ): EventFragment;
...
export type AccessNFTRedeemedEvent = TypedEvent<
...
export type AccessNFTRedeemedEventFilter =
  TypedEventFilter<AccessNFTRedeemedEvent>;

export type AccessNFTsCreatedEvent = TypedEvent<
...
export type AccessNFTsCreatedEventFilter =
  TypedEventFilter<AccessNFTsCreatedEvent>;

export type AccessTransferabilityUpdatedEvent = TypedEvent<
  [boolean],
  { isTransferable: boolean }
>;

export type AccessTransferabilityUpdatedEventFilter =
  TypedEventFilter<AccessTransferabilityUpdatedEvent>;
...
export type LastRedeemTimeUpdatedEvent = TypedEvent<
  [BigNumber, string, BigNumber],
  { accessNftId: BigNumber; creator: string; lastTimeToRedeem: BigNumber }
>;

export type LastRedeemTimeUpdatedEventFilter =
  TypedEventFilter<LastRedeemTimeUpdatedEvent>;
...
export interface AccessNFT extends BaseContract {
  ...
  functions: {
    ...
    setLastTimeToRedeem(
      _tokenId: BigNumberish,
      _secondsUntilRedeem: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "AccessTransferabilityUpdated(bool)"(
      isTransferable?: null
    ): AccessTransferabilityUpdatedEventFilter;
    ...
    ): LastRedeemTimeUpdatedEventFilter;
  ...
  estimateGas: {
    ...
    accessNftIsTransferable(overrides?: CallOverrides): Promise<BigNumber>;
