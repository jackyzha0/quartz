...
export interface IMarketplace extends BaseContract {
    ...
    functions: {
        ...
        buy(_listingId: BigNumberish, _quantity: BigNumberish, _currency: string, _totalPrice: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        buy(_listingId: BigNumberish, _quantity: BigNumberish, _currency: string, _totalPrice: BigNumberish, overrides?: CallOverrides): Promise<void>;
