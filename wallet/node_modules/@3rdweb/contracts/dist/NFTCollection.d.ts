...
export interface NFTCollectionInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "createNativeTokens", values: [string, string[], BigNumberish[], BytesLike]): string;
    encodeFunctionData(functionFragment: "creator", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "erc20WrappedTokens", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "erc721WrappedTokens", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "redeemERC20", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "redeemERC721", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "tokenState", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "wrapERC20", values: [string, BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "wrapERC721", values: [string, BigNumberish, string]): string;
    ...
    decodeFunctionResult(functionFragment: "createNativeTokens", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "creator", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "erc20WrappedTokens", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "erc721WrappedTokens", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "redeemERC20", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "redeemERC721", data: BytesLike): Result;
    ...
    events: {
        ...
        "ERC20Redeemed(address,uint256,address,uint256,uint256)": EventFragment;
        "ERC20WrappedToken(address,address,uint256,uint256,uint256,string)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "ERC20WrappedToken"): EventFragment;
...
export declare type ERC20RedeemedEvent = TypedEvent<[
    string,
    BigNumber,
    string,
    BigNumber,
    ...
    sharesRedeemed: BigNumber;
}>;
export declare type ERC20RedeemedEventFilter = TypedEventFilter<ERC20RedeemedEvent>;
export declare type ERC20WrappedTokenEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    BigNumber,
    ...
    creator: string;
    sourceOfUnderlying: string;
    totalAmountOfUnderlying: BigNumber;
    shares: BigNumber;
    tokenId: BigNumber;
    tokenURI: string;
}>;
export declare type ERC20WrappedTokenEventFilter = TypedEventFilter<ERC20WrappedTokenEvent>;
export declare type ERC721RedeemedEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    BigNumber
    ...
    redeemer: string;
    sourceOfUnderlying: string;
    tokenIdOfUnderlying: BigNumber;
    tokenId: BigNumber;
}>;
export declare type ERC721RedeemedEventFilter = TypedEventFilter<ERC721RedeemedEvent>;
export declare type ERC721WrappedTokenEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    BigNumber,
...
export declare type ERC721WrappedTokenEventFilter = TypedEventFilter<ERC721WrappedTokenEvent>;
export declare type NativeTokensEvent = TypedEvent<[
    string,
    BigNumber[],
    string[],
    BigNumber[]
...
export declare type NativeTokensEventFilter = TypedEventFilter<NativeTokensEvent>;
...
export interface NFTCollection extends BaseContract {
    ...
    functions: {
        ...
        createNativeTokens(to: string, _nftURIs: string[], _nftSupplies: BigNumberish[], data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        creator(_nftId: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        erc20WrappedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            BigNumber,
            BigNumber
        ] & {
        ...
        erc721WrappedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string, BigNumber] & {
            source: string;
            tokenId: BigNumber;
        }>;
        ...
        redeemERC20(_nftId: BigNumberish, _amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        redeemERC721(_nftId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        tokenState(arg0: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            string,
            number
        ] & {
        ...
        wrapERC20(_tokenContract: string, _tokenAmount: BigNumberish, _numOfNftsToMint: BigNumberish, _nftURI: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        wrapERC721(_nftContract: string, _tokenId: BigNumberish, _nftURI: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        contractURI(overrides?: CallOverrides): Promise<string>;
        createNativeTokens(to: string, _nftURIs: string[], _nftSupplies: BigNumberish[], data: BytesLike, overrides?: CallOverrides): Promise<BigNumber[]>;
        creator(_nftId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        erc20WrappedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            BigNumber,
        ...
        paused(overrides?: CallOverrides): Promise<boolean>;
        redeemERC20(_nftId: BigNumberish, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        redeemERC721(_nftId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        uri(_nftId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        wrapERC20(_tokenContract: string, _tokenAmount: BigNumberish, _numOfNftsToMint: BigNumberish, _nftURI: string, overrides?: CallOverrides): Promise<void>;
        wrapERC721(_nftContract: string, _tokenId: BigNumberish, _nftURI: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        ...
        "ERC20Redeemed(address,uint256,address,uint256,uint256)"(redeemer?: string | null, tokenId?: BigNumberish | null, sourceOfUnderlying?: string | null, tokenAmountReceived?: null, sharesRedeemed?: null): ERC20RedeemedEventFilter;
        ERC20Redeemed(redeemer?: string | null, tokenId?: BigNumberish | null, sourceOfUnderlying?: string | null, tokenAmountReceived?: null, sharesRedeemed?: null): ERC20RedeemedEventFilter;
        "ERC20WrappedToken(address,address,uint256,uint256,uint256,string)"(creator?: string | null, sourceOfUnderlying?: string | null, totalAmountOfUnderlying?: null, shares?: null, tokenId?: null, tokenURI?: null): ERC20WrappedTokenEventFilter;
        ERC20WrappedToken(creator?: string | null, sourceOfUnderlying?: string | null, totalAmountOfUnderlying?: null, shares?: null, tokenId?: null, tokenURI?: null): ERC20WrappedTokenEventFilter;
        "ERC721Redeemed(address,address,uint256,uint256)"(redeemer?: string | null, sourceOfUnderlying?: string | null, tokenIdOfUnderlying?: null, tokenId?: null): ERC721RedeemedEventFilter;
        ERC721Redeemed(redeemer?: string | null, sourceOfUnderlying?: string | null, tokenIdOfUnderlying?: null, tokenId?: null): ERC721RedeemedEventFilter;
        "ERC721WrappedToken(address,address,uint256,uint256,string)"(creator?: string | null, sourceOfUnderlying?: string | null, tokenIdOfUnderlying?: null, tokenId?: null, tokenURI?: null): ERC721WrappedTokenEventFilter;
        ERC721WrappedToken(creator?: string | null, sourceOfUnderlying?: string | null, tokenIdOfUnderlying?: null, tokenId?: null, tokenURI?: null): ERC721WrappedTokenEventFilter;
        "NativeTokens(address,uint256[],string[],uint256[])"(creator?: string | null, tokenIds?: null, tokenURIs?: null, tokenSupplies?: null): NativeTokensEventFilter;
        NativeTokens(creator?: string | null, tokenIds?: null, tokenURIs?: null, tokenSupplies?: null): NativeTokensEventFilter;
    ...
    estimateGas: {
        ...
        creator(_nftId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        erc20WrappedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        erc721WrappedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        tokenState(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        tokenURI(_nftId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        totalSupply(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        creator(_nftId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        erc20WrappedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        erc721WrappedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        tokenState(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        tokenURI(_nftId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        uri(_nftId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        wrapERC20(_tokenContract: string, _tokenAmount: BigNumberish, _numOfNftsToMint: BigNumberish, _nftURI: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        wrapERC721(_nftContract: string, _tokenId: BigNumberish, _nftURI: string, overrides?: Overrides & {
