...
export interface SignatureMint721Interface extends utils.Interface {
    functions: {
...
export interface SignatureMint721 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SignatureMint721Interface;
    ...
    callStatic: {
        ...
        mintWithSignature(_req: MintRequestStruct, _signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
