...
export interface SignatureMint1155Interface extends utils.Interface {
    functions: {
        ...
        "defaultRoyaltyRecipient()": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "defaultRoyaltyRecipient", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "defaultRoyaltyRecipient", data: BytesLike): Result;
...
export declare type NewDefaultRoyaltyRecipientEvent = TypedEvent<[
    string
], {
    recipient: string;
}>;
export declare type NewDefaultRoyaltyRecipientEventFilter = TypedEventFilter<NewDefaultRoyaltyRecipientEvent>;
export declare type NewDefaultSaleRecipientEvent = TypedEvent<[
    string
], {
    recipient: string;
}>;
export declare type NewDefaultSaleRecipientEventFilter = TypedEventFilter<NewDefaultSaleRecipientEvent>;
...
export interface SignatureMint1155 extends BaseContract {
    ...
    functions: {
        ...
        defaultRoyaltyRecipient(overrides?: CallOverrides): Promise<[string]>;
        ...
        mintWithSignature(_req: MintRequestStruct, _signature: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        verify(_req: MintRequestStruct, _signature: BytesLike, overrides?: CallOverrides): Promise<[boolean, string]>;
    };
    DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
    MINTER_ROLE(overrides?: CallOverrides): Promise<string>;
    TRANSFER_ROLE(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        mintWithSignature(_req: MintRequestStruct, _signature: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "NewDefaultRoyaltyRecipient(address)"(recipient?: string | null): NewDefaultRoyaltyRecipientEventFilter;
        NewDefaultRoyaltyRecipient(recipient?: string | null): NewDefaultRoyaltyRecipientEventFilter;
        "NewDefaultSaleRecipient(address)"(recipient?: string | null): NewDefaultSaleRecipientEventFilter;
        NewDefaultSaleRecipient(recipient?: string | null): NewDefaultSaleRecipientEventFilter;
        ...
        "TokenMinted(address,uint256,string,uint256)"(mintedTo?: string | null, tokenIdMinted?: BigNumberish | null, uri?: null, quantityMinted?: null): TokenMintedEventFilter;
    ...
    estimateGas: {
        ...
        defaultRoyaltyRecipient(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        verify(_req: MintRequestStruct, _signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        defaultRoyaltyRecipient(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        verify(_req: MintRequestStruct, _signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
