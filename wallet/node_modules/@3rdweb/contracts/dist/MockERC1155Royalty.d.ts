...
export interface MockERC1155RoyaltyInterface extends utils.Interface {
    functions: {
...
export interface MockERC1155Royalty extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockERC1155RoyaltyInterface;
