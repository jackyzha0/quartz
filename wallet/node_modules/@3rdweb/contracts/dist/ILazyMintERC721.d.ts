...
export interface ILazyMintERC721 extends BaseContract {
    ...
    functions: {
        claim(receiver: string, _quantity: BigNumberish, _proofs: BytesLike[], overrides?: PayableOverrides & {
    ...
    callStatic: {
        claim(receiver: string, _quantity: BigNumberish, _proofs: BytesLike[], overrides?: CallOverrides): Promise<void>;
