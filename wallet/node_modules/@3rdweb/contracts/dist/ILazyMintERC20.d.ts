...
export interface ILazyMintERC20 extends BaseContract {
    ...
    functions: {
        claim(receiver: string, quantity: BigNumberish, proofs: BytesLike[], overrides?: PayableOverrides & {
    ...
    callStatic: {
        claim(receiver: string, quantity: BigNumberish, proofs: BytesLike[], overrides?: CallOverrides): Promise<void>;
