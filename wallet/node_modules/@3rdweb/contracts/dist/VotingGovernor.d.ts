...
export interface VotingGovernorInterface extends utils.Interface {
    functions: {
        ...
        "indexForProposal(uint256)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "indexForProposal", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "indexForProposal", data: BytesLike): Result;
...
export interface VotingGovernor extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: VotingGovernorInterface;
    ...
    functions: {
        ...
        getAllProposals(overrides?: CallOverrides): Promise<[
            ...
            allProposals: ProposalStructOutput[];
        }>;
        ...
        indexForProposal(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        indexForProposal(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
