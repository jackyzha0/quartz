...
function JsonProperty() {
    ...
    return function (target, classPropertyName) {
        ...
        var convertingMode = json_convert_enums_1.PropertyConvertingMode.MAP_NULLABLE;
        switch (params.length) {
            ...
            case 3:
                ...
                conversionOption = params[1];
                if (params[2] === true) {
                    convertingMode = json_convert_enums_1.PropertyConvertingMode.IGNORE_NULLABLE;
                }
                else if (params[2] === json_convert_enums_1.PropertyConvertingMode.IGNORE_NULLABLE ||
                    params[2] === json_convert_enums_1.PropertyConvertingMode.PASS_NULLABLE ||
                    params[2] === json_convert_enums_1.PropertyConvertingMode.MAP_NULLABLE) {
                    convertingMode = params[2];
                }
                else {
                    convertingMode = json_convert_enums_1.PropertyConvertingMode.MAP_NULLABLE;
                }
                break;
            default:
                break;
