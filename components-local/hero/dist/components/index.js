// components-local/hero/src/heroSim.ts
var heroSim_default = `(function () {
...
var Hero = ({ fileData }) => {
  ...
  return /* @__PURE__ */ jsxs("section", { class: "hero", children: [
    ...
    /* @__PURE__ */ jsxs("div", { class: "hero-canvas-wrap", children: [
      /* @__PURE__ */ jsx("canvas", { id: "hero-canvas", "aria-hidden": "true" }),
      /* @__PURE__ */ jsx("p", { class: "hero-canvas-hint micro-label", "aria-hidden": "true", children: "a living spiking network \u2014 hover to excite it" })
    ] })
  ] });
};
Hero.afterDOMLoaded = heroSim_default;
